 ...
 */
    ...
    #define ESP_PANEL_LCD_RGB_VFP               (1)
    #define ESP_PANEL_LCD_RGB_PCLK_ACTIVE_NEG   (0)
    
    // Enable Bounce Buffer to prevent DMA underflow (Screen Jitter)
    // Increased to 40 lines (approx 80KB SRAM) to handle heavy UI updates
    #define ESP_PANEL_LCD_RGB_BOUNCE_BUF_SIZE   (DISPLAY_WIDTH * 40) 
