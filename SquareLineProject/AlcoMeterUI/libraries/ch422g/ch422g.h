...
#define CH422G_IO_4          0x04  // IO4 (SD card CS pin)
#define CH422G_IO_5          0x05  // IO5 (Select communication interface: 0 for USB, 1 for CAN)
#define CH422G_IO_6          0x06  // IO6
#define CH422G_IO_7          0x07  // IO7
