 ...
 */
#define EXAMPLE_LCD_H_RES               (LVGL_PORT_H_RES)  ///< Horizontal resolution in pixels
#define EXAMPLE_LCD_V_RES               (LVGL_PORT_V_RES)  ///< Vertical resolution in pixels
...
// Dynamic buffer count based on rotation
#if EXAMPLE_LVGL_PORT_ROTATION_DEGREE != 0
#define EXAMPLE_LCD_RGB_BUFFER_NUMS     (3)    ///< Use 3 buffers for rotation
#else
#define EXAMPLE_LCD_RGB_BUFFER_NUMS     (2)    ///< Use 2 buffers for normal operation
#endif
